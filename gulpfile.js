...
function rebuild(options) {
  ...
  browserifyTask({
    development: options.development,
    src: './eatsmart/static/js/index.js',
    dest: './eatsmart/static/js/'
  });

  cssTask({
    development: options.development,
    src: './eatsmart/static/less/index.less',
    watch: './eatsmart/static/less/**/*.less',
    dest: './eatsmart/static/css/'
  });
}
...
gulp.task('test', function () {
  ...
  return gulp
    ...
    .on('finish', function () {
      gulp
        .src('./eatsmart/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
