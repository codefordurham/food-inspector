...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # inspections
        inspections = self.get_inpsections()

        # violations
        violations = self.get_county_data()

    def get_county_data(self, url):
        resp = requests.get('http://data.wake.opendata.arcgis.com/datasets/ebe3ae7f76954fad81411612d7c4fb17_1.geojson')
        json_resp = resp.json()
    ...
    def get_restaurants(self):
        resp = requests.get('http://data.wake.opendata.arcgis.com/datasets/124c2187da8c41c59bde04fa67eb2872_0.geojson?where=&geometry={"xmin":-8992487.871106919,"ymin":4226590.155355151,"xmax":-8508182.859892275,"ymax":4318314.589297318,"spatialReference":{"wkid":102100}}')
        json_resp = resp.json()
        if 'features' in json_resp:
            return json_resp['features']
        time.sleep(30)  # wake queues up the response
